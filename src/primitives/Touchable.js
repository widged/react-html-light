...
export default class Touchable extends Component {
  ...
  checkTouchWithinActive(e) {
    ...
    return (
      ...
      pageX < positionOnGrant.left + positionOnGrant.width + pressExpandRight &&
      pageY < positionOnGrant.top + positionOnGrant.height + pressExpandBottom
    );
  }
  ...
  render() {
    ...
    const events = disabled ? undefined : copy(this, ["onMouseDown"]);
    ...
    const cloned = React.cloneElement(child, events);
    return cloned;
  }
}

/*
https://raw.githubusercontent.com/facebook/react-360/master/packages/react-webgl/src/Pressable.react.js
/**
